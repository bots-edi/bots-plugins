...
def main(inn,out):
    ...
    if LEVERDATUM:
        if len(LEVERDATUM) == 8:
            ...
            FLEVERDATUM = '203'
        out.put({'BOTSID':'UNH'},{'BOTSID':'DTM','C507.2005':'35','C507.2380':LEVERDATUM})
        out.put({'BOTSID':'UNH'},{'BOTSID':'DTM','C507.2005':'35','C507.2379':FLEVERDATUM})
    ...
    for count in range(1,4):
        DAGEN = inn.getnozero({'BOTSID':'HEA','DAGNAFACTUUR%s'%count:None})
        if DAGEN:
            pat = out.putloop({'BOTSID':'UNH'},{'BOTSID':'PAT'})
            pat.put({'BOTSID':'PAT','4279':'22','C112.2475':'5','C112.2009':'3','C112.2151':'D','C112.2152':DAGEN})
            pat.put({'BOTSID':'PAT'},{'BOTSID':'PCD','C501.5245':'12','C501.5482':inn.get({'BOTSID':'HEA','PERCENTKORTING%s'%count:None})})
    ...
    out.put({'BOTSID':'UNH'},{'BOTSID':'UNS','0081':'S'})
    out.put({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'79','C516.5004':inn.get({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALREGEL':None})})
    out.put({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'131','C516.5004':inn.getnozero({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALFACTUURKORTING':None})})
    out.put({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'176','C516.5004':inn.get({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALBTW':None})})
    out.put({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'77','C516.5004':inn.get({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALFACTUUR':None})})
    out.put({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'129','C516.5004':inn.getnozero({'BOTSID':'HEA'},{'BOTSID':'TOT','GRONDSLAGBETKORTING':None})})
    for count in range(1,5):
        BTWTARIEF = inn.get({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWTARIEF%s'%count:None})
        if BTWTARIEF:
            tax = out.putloop({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'TAX'})
            tax.put({'BOTSID':'TAX','5283':'7','C241.5153':'VAT','5305':BTWTARIEF})
            tax.put({'BOTSID':'TAX','5283':'7','C241.5153':'VAT','C243.5278':inn.get({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWPERCENTAGE%s'%count:None})})
            tax.put({'BOTSID':'TAX','5283':'7','C241.5153':'VAT'},{'BOTSID':'MOA','C516.5025':'125','C516.5004':inn.get({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWGRONDSLAG%s'%count:None})})
            tax.put({'BOTSID':'TAX','5283':'7','C241.5153':'VAT'},{'BOTSID':'MOA','C516.5025':'124','C516.5004':inn.get({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWBEDRAG%s'%count:None})})
