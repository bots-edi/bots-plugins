...
def main(inn,out):
    ...
    count = 0
    for pat in inn.getloop({'BOTSID':'UNH'},{'BOTSID':'PAT'}):
        count += 1
        out.put({'BOTSID':'HEA','DAGNAFACTUUR%s'%count:pat.get({'BOTSID':'PAT','4279':'22','C112.2475':'5','C112.2009':'3','C112.2151':'D','C112.2152':None})})
        out.put({'BOTSID':'HEA','PERCENTKORTING%s'%count:pat.get({'BOTSID':'PAT','4279':'22','C112.2475':'5','C112.2009':'3','C112.2151':'D'},{'BOTSID':'PCD','C501.5245':'12','C501.5482':None})})
    ...
    out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALREGEL':inn.get({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'79','C516.5004':None})})
    out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALFACTUURKORTING':inn.get({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'131','C516.5004':None})})
    out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALBTW':inn.get({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'176','C516.5004':None})})
    out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','TOTAALFACTUUR':inn.get({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'77','C516.5004':None})})
    out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','GRONDSLAGBETKORTING':inn.get({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'MOA','C516.5025':'129','C516.5004':None})})
    
    count = 0
    for tax in inn.getloop({'BOTSID':'UNH'},{'BOTSID':'UNS'},{'BOTSID':'TAX'}):
        count += 1
        out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWTARIEF%s'%count:tax.get({'BOTSID':'TAX','5283':'7','C241.5153':'VAT','5305':None})})
        out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWPERCENTAGE%s'%count:tax.get({'BOTSID':'TAX','5283':'7','C241.5153':'VAT','C243.5278':None})})
        out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWGRONDSLAG%s'%count:tax.get({'BOTSID':'TAX','5283':'7','C241.5153':'VAT'},{'BOTSID':'MOA','C516.5025':'125','C516.5004':None})})
        out.put({'BOTSID':'HEA'},{'BOTSID':'TOT','BTWBEDRAG%s'%count:tax.get({'BOTSID':'TAX','5283':'7','C241.5153':'VAT'},{'BOTSID':'MOA','C516.5025':'124','C516.5004':None})})
